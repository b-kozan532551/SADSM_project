...
def hist_plot(data, x_values, title='', x_label='', y_label='', file_name='user_histplot', folder_name='plots'):
    plt.figure(figsize=(15, 6))
    sns.histplot(x=x_values, data=data, bins=5, kde=True)
...
def hist_plot_hue(data, x_values, title='', x_label='', y_label='', file_name='user_histplothue', hue='', folder_name='plots'):
    plt.figure(figsize=(15, 6))
    sns.histplot(x=x_values, data=data, bins=9, hue=hue, palette='tab10')
