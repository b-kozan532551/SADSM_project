...
def violin_plot(data, x_values, y_values, title='', x_label='', y_label='', file_name='user_violin_plot', folder_name='plots'):
    plt.figure(figsize=(10, 6))
    sns.violinplot(x=x_values, y=y_values, data=data)
